            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <div className="flex flex-col space-y-1.5">
                  <span className={`w-5 h-0.5 bg-xuan-gold transition-all duration-300 ${isMobileMenuOpen ? 'rotate-45 translate-y-2' : ''}`} />
                  <span className={`w-5 h-0.5 bg-xuan-gold transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0' : ''}`} />
                  <span className={`w-5 h-0.5 bg-xuan-gold transition-all duration-300 ${isMobileMenuOpen ? '-rotate-45 -translate-y-2' : ''}`} />
                </div>
              </button>
            </div>
            ...
            <div className="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-xuan-dark border-l border-xuan-gold/20 overflow-y-auto">
              <div className="p-6">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <button onClick={() => setIsMobileMenuOpen(false)} className="w-10 h-10 flex items-center justify-center rounded-lg border border-xuan-border hover:border-xuan-gold/50 transition-colors">
                    <svg className="w-5 h-5 text-xuan-silver" fill="none" viewBox="0 0 24 24" stroke="currentColor">
